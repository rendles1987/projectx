...
csv_propinfo = namedtuple('csv_propinfo', [
...
NOT_COLUMN_NAMES = [
    CSV_FILE_DIR, GAME_TYPE, CSV_FILE_NAME, COUNTRY, GAME_NAME, SEASON]
...
DEFAULT_COLUMN_NAMES = [DATE, HOME, AWAY, HOME_GOALS, AWAY_GOALS, URL,
